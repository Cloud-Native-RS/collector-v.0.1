...
export async function generateMetadata() {
  return generateMeta({
    title: "Dashboard",
    description:
      "A modern and elegant responsive admin Dashboard. Easily manage, analyze, and report your data. Built with shadcn/ui, Tailwind CSS, Next.js.",
    canonical: "/sales"
  });
}

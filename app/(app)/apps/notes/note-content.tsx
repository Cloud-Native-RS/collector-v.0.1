...
import { AddNoteModal } from "@/app/(app)/apps/notes/add-note-modal";
import { Note } from "@/app/(app)/apps/notes/types";
import NoteListItem from "@/app/(app)/apps/notes/note-list-item";
import { notes } from "@/app/(app)/apps/notes/data";
import { NoteMobileSidebar } from "@/app/(app)/apps/notes/note-sidebar";

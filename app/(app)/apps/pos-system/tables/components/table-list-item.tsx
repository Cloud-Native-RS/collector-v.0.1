...
import { useStore, Table } from "@/app/(app)/apps/pos-system/store";
import {
  EnumTableStatus,
  EnumTableStatusColor
} from "@/app/(app)/apps/pos-system/enums";

import { Badge } from "@/components/ui/badge";
import TableDetailDialog from "@/app/(app)/apps/pos-system/tables/components/table-detail-dialog";

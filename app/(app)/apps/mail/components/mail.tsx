...
import { NavDesktop } from "@/app/(app)/apps/mail/components/nav-desktop";
import { NavMobile } from "@/app/(app)/apps/mail/components/nav-mobile";
import { MailDisplayMobile } from "@/app/(app)/apps/mail/components/mail-display-mobile";

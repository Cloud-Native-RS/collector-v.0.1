...
import { GripVertical, PlusCircleIcon, SearchIcon } from "lucide-react";
...
import { crmApi, type DealStage as ApiDealStage } from "@/lib/api/crm";
...
export default function DealsKanbanBoard({ deals, onRefresh }: DealsKanbanBoardProps) {
            ...
            <Kanban.Column
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold">{stageTitles[stage]}</span>
              ...
              {stageDeals.length > 0 && (
                <div className="mb-4 p-2 bg-muted rounded-md text-xs space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      ${weightedValue(stageDeals).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                    </span>
                  </div>
                </div>
              )}

...
export async function GET(
  ...
  return proxyRequest(request, `/api/activities/${id}`);
}
...
export async function PUT(
  ...
  return proxyRequest(request, `/api/activities/${id}`, 'PUT', body);
}
...
export async function DELETE(
  ...
  const { id } = await params;
  return proxyRequest(request, `/api/activities/${id}`, 'DELETE');
}

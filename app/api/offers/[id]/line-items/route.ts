...
async function proxyRequest(
  ...
  try {
    ...
    const url = new URL(`${OFFERS_SERVICE_URL}/api/offers/${offerId}/line-items`);
    ...
    console.error('Offers line-items API proxy error:', error);
    return NextResponse.json(
      { 
        success: false, 
...
export async function POST(
  ...
  return proxyRequest(request, id, 'POST', body);
}
